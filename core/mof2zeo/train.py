# NOTE: This script documents how the shipped mof2zeo checkpoint was trained. It is NOT part of
# the runtime loop and is not required to run LLM4MOF. The training data
# (core/mof2zeo/data/train.csv, valid.csv) is not bundled due to size and is available on request;
# runtime inference uses only the trained checkpoint + scaler/vocabulary files.
import os
import sys
import yaml
import torch
