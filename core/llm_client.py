# =============================================================================
# LLM4MOF Autonomous System - LLM Client
# =============================================================================
...
class LLMClient:
    ...
    def __init__(self, system_prompt: str, multi_turn: bool = False, usage_log_path: Optional[str] = None):
        """
    ...
    def set_usage_log_path(self, path: str) -> None:
        """Set or update the usage log path after initialization."""
        self.usage_log_path = path

    def _log_usage(self, model: str, prompt_tokens: int, completion_tokens: int, cached_tokens: int) -> None:
        """Append a usage record to usage_log.json.

        Args:
            model: Actual model ID returned by the API
            prompt_tokens: Total input tokens billed
