...
compute llm4mof_pe all pe
variable llm4mof_A equal c_llm4mof_pe

thermo_style custom temp c_llm4mof_pe
thermo 1
run 0

print "{{{{}}}}:${{llm4mof_A}}" append {{0}}_energy.txt

write_data           {1}

uncompute llm4mof_pe
variable llm4mof_A delete
"""
